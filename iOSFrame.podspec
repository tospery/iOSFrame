#
# Be sure to run `pod lib lint iOSFrame.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/tospery/iOSFrame'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tospery' => 'tospery@gmail.com' }
  s.source           = { :git => 'https://github.com/tospery/iOSFrame.git', :tag => s.version.to_s }
  ...
  s.source_files = 'iOSFrame/Classes/**/*'
  
  s.resource_bundles = {
    'iOSFrame' => ['iOSFrame/Assets/*.png']
  }
